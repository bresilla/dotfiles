...
"CMAKE
autocmd FileType cpp map <C-F7> <ESC><Esc>:!cmake --build build/ --target<CR>
autocmd FileType cpp map <C-F8> <ESC><Esc>:!rm -rf build/*<CR>:!cmake -H. -Bbuild -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_BUILD_TYPE=Debug<CR>
autocmd FileType cpp map <C-F9> <ESC><Esc>:!rm -rf build/*<CR>:!cmake -H. -Bbuild -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_BUILD_TYPE=FastDebug<CR>
autocmd FileType cpp map <F7> <ESC><Esc>:!ninja -C build<CR>
